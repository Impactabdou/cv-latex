...
\newcommand{\CVFirstName}{Loïck}
\newcommand{\CVLastName}{DUPONT}
\newcommand{\CVJobTitle}{Consultant Transformation Digitale}
\newcommand{\CVApplicationRef}{LOICK-2027}
\newcommand{\CVPhone}{+33 6 12 34 56 78}
\newcommand{\CVEmail}{loick.dupont@consulting.fr}
...
\newcommand{\CVProfileText}{Préparant un double diplôme Ingénieur-Manager (ENSICAEN / EM Normandie), \textbf{je recherche un stage de 6 mois (janv. 2027)} en Conseil Techno \& Transformation SI pour accompagner la croissance et l'innovation de vos clients.}
...
\newcommand{\EduOneModules}{\textbf{Modules} : Conduite du changement, Management des organisations, Contrôle budgétaire, Business Models.}
...
\newcommand{\EduTwoModules}{\textbf{Modules Data / Tech} : Architecture SI, Cloud Computing, Databases, Sécurité applicative.}
...
\newcommand{\SkillsTools}{AWS, Azure, GitLab (CI/CD), Kubernetes, Docker, Ansible, Helm, Prometheus, Grafana.}
